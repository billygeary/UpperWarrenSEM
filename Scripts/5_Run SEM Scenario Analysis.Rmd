...
```{r}
z=ggplot(data) + geom_smooth(aes(x=PeriodID, y = rain.anomaly.twelve)) + facet_wrap(~TRANSECT)

y=ggplot(data) + geom_smooth(aes(x=rain.anomaly.twelve, y = Woylie_Abundance), method = 'lm')
